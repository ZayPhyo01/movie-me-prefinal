...
public class NowPlayingHolder extends BaseHolder<MovieResult> {

    TextView textView;
    ImageView imageView;

    public NowPlayingHolder(View itemView, MovieDetailController movieDetailController, List<MovieResult>movieResults) {
