...
@Database(entities = {DbTob.class,DbPopular.class,DbNowPlaying.class,Detail.class},version = 14)
@TypeConverters({ListConvetor.class,CompanyConvetor.class})
public abstract class Dbinstance extends RoomDatabase {


        private static final String DB_NAME = "meoffline_playing_dbases14";
